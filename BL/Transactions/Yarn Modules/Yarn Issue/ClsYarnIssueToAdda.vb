...
Public Class ClsYarnIssueToAdda
...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            'save purchase order
            Dim strCommand As String = "SP_MFG_YARNISSUEADDA_SAVE"
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_MFG_YARNISSUEADDA_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function selectYARNISSUE() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_SELECTYARNISSUEADDA_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_MFG_YARNISSUEADDA_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@YISSUENO", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@YearID", alParaval(1)))
