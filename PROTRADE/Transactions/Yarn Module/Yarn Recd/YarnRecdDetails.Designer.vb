...
Partial Class YarnRecdDetails
    ...
    Private Sub InitializeComponent()
        ...
        Me.GGODOWNRECNO = New DevExpress.XtraGrid.Columns.GridColumn()
        Me.GGODOWNDATE = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        'GGODOWNRECNO
        '
        Me.GGODOWNRECNO.Caption = "Godown Rec No"
        Me.GGODOWNRECNO.FieldName = "GODOWNNO"
        Me.GGODOWNRECNO.Name = "GGODOWNRECNO"
        Me.GGODOWNRECNO.Visible = True
        Me.GGODOWNRECNO.VisibleIndex = 23
        '
        'GGODOWNDATE
        '
        Me.GGODOWNDATE.Caption = "Godown Date"
        Me.GGODOWNDATE.DisplayFormat.FormatString = "dd/MM/YYYY"
        Me.GGODOWNDATE.DisplayFormat.FormatType = DevExpress.Utils.FormatType.DateTime
        Me.GGODOWNDATE.FieldName = "GODOWNDATE"
        Me.GGODOWNDATE.Name = "GGODOWNDATE"
        Me.GGODOWNDATE.Visible = True
        Me.GGODOWNDATE.VisibleIndex = 24
        '
        'GNARRATION
        '
    ...
    Friend WithEvents GGODOWNRECNO As DevExpress.XtraGrid.Columns.GridColumn
    Friend WithEvents GGODOWNDATE As DevExpress.XtraGrid.Columns.GridColumn
