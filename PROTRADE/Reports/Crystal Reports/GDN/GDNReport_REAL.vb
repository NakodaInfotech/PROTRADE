...
Public Class GDNReport_REAL
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PROTRADE.GDNReport_REAL.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGDNReport_REAL
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GDNReport_REAL = New GDNReport_REAL()
        rpt.Site = Me.Site
        Return rpt
    End Function
