...
Public Class HomePage
    ...
    Private Sub HomePage_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            If ClientName = "AVIS" Or ClientName = "SUPRIYA" Or ClientName = "KRISHNA" Or ClientName = "SONU" Then
        ...
        Try
            ...
            If ALLOWBARCODEPRINT = True Then
                ...
                If ClientName = "REAL" Then
                    GCOLOR.Visible = True
                    GCOLOR.VisibleIndex = 1
                    dt = OBJCMN.search(" ITEMNAME, COLOR, SUM(PCS) AS PCS, SUM(MTRS) AS MTRS ", "", " BARCODESTOCK ", WHERECLAUSE & " AND YEARID = " & YearId & " GROUP BY ITEMNAME, COLOR ORDER BY ITEMNAME, COLOR")
                Else
            ...
            Else
                ...
                dt = OBJCMN.search(" ITEMNAME, (SUM(PCS)-SUM(ISSPCS)) AS PCS, (SUM(MTRS)-SUM(ISSMTRS)) AS MTRS", "", " STOCKREGISTER ", " AND YEARID = " & YearId & " GROUP BY ITEMNAME HAVING (SUM(MTRS)-SUM(ISSMTRS)) > 0")
            End If
